...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 24-09-2016 a las 02:19:06
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `pa_ins_producto` (`id_unidad_medida` INT, `nombre` VARCHAR(100), `descripccion` VARCHAR(500))  begin
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `pa_upd_producto` (`p_ip_producto` INT, `p_id_unidad_medida` INT, `p_nombre` VARCHAR(100), `p_descripcion` VARCHAR(500))  begin
update tbl_producto
set
